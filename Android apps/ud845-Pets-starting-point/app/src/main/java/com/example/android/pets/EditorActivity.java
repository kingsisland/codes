...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void savePet() {
        ...
        int weight;
        if (nameString.isEmpty() && breedString.isEmpty() && weightString.isEmpty() && mGender==PetEntry.GENDER_UNKNOWN)
        {
            Toast.makeText(this,"Please enter valid Pet details",Toast.LENGTH_SHORT).show();
            return;
        }
